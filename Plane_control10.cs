...
public class Plane_Control10 : MonoBehaviour
{
    ...
    void information_update()
    {
        ...
        distance_drone10 = math_distance(local_Position_x, local_Position_y, local_Position_z, target_x, target_y, target_z);
        drone10_found = found(distance_drone10);
        uavs.GetComponent<control_center>().drone10_found = drone10_found;
        uavs.GetComponent<control_center>().distance_drone10_target = distance_drone10;
