...
public class Plane_Control2 : MonoBehaviour
{
    ...
    void information_update()
    {
        ...
        distance_drone2 = math_distance(local_Position_x, local_Position_y, local_Position_z, target_x, target_y, target_z);
