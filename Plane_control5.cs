...
public class Plane_Control5 : MonoBehaviour
{
    ...
    void information_update()
    {
        ...
        distance_drone5 = math_distance(local_Position_x, local_Position_y, local_Position_z, target_x, target_y, target_z);
        drone5_found = found(distance_drone5);
        uavs.GetComponent<control_center>().drone5_found = drone5_found;
        uavs.GetComponent<control_center>().distance_drone5_target = distance_drone5;
