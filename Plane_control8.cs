...
public class Plane_Control8 : MonoBehaviour
{
    ...
    void information_update()
    {
        ...
        distance_drone8 = math_distance(local_Position_x, local_Position_y, local_Position_z, target_x, target_y, target_z);
        drone8_found = found(distance_drone8);
        uavs.GetComponent<control_center>().drone8_found = drone8_found;
        uavs.GetComponent<control_center>().distance_drone8_target = distance_drone8;
